...
const PostCard = ({post}) => {
    ...
    const [heart,setHeart] = useState(post.likes_count)
    const currentUser = {};
  ...
  return (
    <div className='bg-white rounded-xl shadow  p-4  shadow-y-4 w-full max-w-2xl' >
      <div onClick={()=>useNavigate('/profile/' + post.user._id)} className='inline-flex  items-center gap-3 cursor-pointer'>
